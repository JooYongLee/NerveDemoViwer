...
public slots:
    ...
    void triggeredJawBone();
    void triggeredBackground();
    void triggeredMentalNerve();
    void triggeredEndLowercase();
...
private:
    ...
    QAction *ActionMentalNerve;
    QAction *ActionJawBone;
    QAction *ActionEndLowercase;
